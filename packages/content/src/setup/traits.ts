...
export const traits: TraitCard[] = [
  ...
  },
  {
    ...
    statMods: { mindset: 10, knowledge: -4 },
  },
  {
    id: 'trait_risk_taker',
    label: '天生胆大',
    ...
    statMods: { mindset: 6, knowledge: -3 },
  },
  {
    id: 'trait_homebody',
    label: '恋家',
  ...
  },
  {
    ...
    statMods: { network: 12, knowledge: -5 },
  },
  {
    id: 'trait_sensitive',
    label: '心思细腻',
    ...
    statMods: { knowledge: 5, network: 3, mindset: -6 },
  },
];
