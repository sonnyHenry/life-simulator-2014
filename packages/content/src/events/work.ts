    ...
    choices: [
      {
        ...
        outcomes: [
          {
            weight: 1,
            text: '除夕在一家吃年夜饭，初二一早拖着行李赶去另一家，后备箱塞满两边互赠的特产——有两样是重的。累是累，但两桌饭你们都没缺席。回程的高速上{{ta}}睡着了，你忽然觉得，所谓成家，就是从“回家过年”变成“带着家回家过年”。',
      ...
      },
      {
        ...
        outcomes: [
          {
            weight: 1,
            text: '你们订了张大桌，把四位老人接到了自己的小家。厨房挤了四个指挥官，一顿年夜饭做出了满汉全席的阵仗。饭桌上两位爸爸从白酒聊到孙辈，你和{{ta}}在桌下交换了一个“完了”的眼神。房子很挤，挤得很像一个家。',
