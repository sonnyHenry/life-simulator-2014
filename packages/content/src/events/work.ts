    ...
    choices: [
      ...
      },
      {
        ...
        outcomes: [
          {
            weight: 1,
            text: '那场会不是裁你,是给你选择:转岗到一个更累的业务,薪包"结构调整",干不干?你想起房租、想起家里的电话、想起脉脉上"三十岁投一百份简历无人问津"的帖子,说:干。于是你留下来了。留下来的代价是接手了三个人的活,奖金缩了一圈,团建取消,连零食柜都变得空空荡荡。离开的同事在群里发"山高水长,后会有期",配了合照。你盯着合照看了一会儿,把它保存了下来。幸存者没有掌声,只有更多的需求排期,和一个再也不敢关声音的钉钉。',
            effects: [
