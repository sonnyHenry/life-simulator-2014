...
export const dramaEvents: GameEvent[] = [
        ...
        outcomes: [
          {
            ...
            effects: [{ stats: { money: -50000, mindset: -9, health: -4 } }, { setFlag: 'pig_butchered' }],
          },
        ],
      },
      {
        ...
        outcomes: [
          {
            ...
            effects: [{ stats: { money: -140000, mindset: -12, health: -6 } }, { setFlag: 'pig_butchered' }],
          },
        ],
      },
      {
    ...
    choices: [
      {
        ...
        outcomes: [
          ...
          },
          {
            ...
            outcomeTag: 'failure',
            effects: [{ stats: { money: -60000, mindset: -6 } }],
          },
        ],
      },
      {
        ...
        outcomes: [
          ...
          },
          {
            ...
            outcomeTag: 'failure',
            effects: [{ stats: { money: -180000, mindset: -10, health: -5 } }],
          },
        ],
      },
      {
  ...
  },
  {
    ...
    tier: 'major',
    title: '爸爸的检查单',
    trigger: { all: [{ year: { from: 2023, to: 2025 } }, working] },
        ...
        outcomes: [
          {
            ...
            effects: [{ stats: { money: -30000, mindset: 5, health: -4, network: -2 } }, { setFlag: 'parent_ill' }],
          },
          {
            weight: 1,
            text: '手术台上发现情况比影像里复杂,术后又进了一次 ICU。你在缴费窗口和病房之间跑了一个月,工资卡见了底,人瘦了一圈。爸爸最终挺过来了。出院那天他拉着你的手说"回去上班吧",你在机场哭得像个高考失利的孩子。',
            effects: [{ stats: { money: -70000, mindset: -6, health: -8 } }, { setFlag: 'parent_ill' }],
          },
        ],
      },
      {
        id: 'b',
        text: '砸钱解决:专家号、特需病房、金牌护工',
        outcomes: [
          {
            weight: 1,
            text: '你托关系挂了专家号,订了特需病房,请了最贵的护工,自己视频"云查房"。手术顺利,账单惊人。出院后妈妈跟你说:"护工是好,可你爸半夜疼醒,喊的是你的名字。"这句话你记了很多年——原来钱能买到最好的照顾,买不到"在场"。',
            effects: [{ stats: { money: -90000, mindset: -8 } }, { setFlag: 'parent_ill' }],
          },
        ],
      },
      {
        ...
        outcomes: [
          {
            ...
            effects: [{ stats: { money: -20000, mindset: -10, network: -3 } }, { setFlag: 'parent_ill' }],
          },
        ],
      },
    ],
    ...
    choices: [
      {
        ...
        outcomes: [
          ...
          },
          {
            ...
            outcomeTag: 'partial',
            effects: [{ stats: { money: -12000, network: 4, mindset: -3 } }],
          },
        ],
      },
      {
        ...
        outcomes: [
          {
            ...
            outcomeTag: 'failure',
            effects: [{ stats: { money: -100000, mindset: -10, network: -5 } }],
          },
          {
            weight: 1,
        ...
        outcomes: [
          {
            ...
            effects: [{ stats: { money: -50000, mindset: 15, health: 12 } }],
          },
          {
            weight: 1,
            text: '休息是真舒服,复出是真艰难。市场比你想的更冷,空窗期在面试官眼里越来越刺眼,最后你接了个降薪三成的 offer。你不后悔那半年,只是明白了:自由是有标价的,而且不打折。',
            effects: [{ stats: { money: -80000, mindset: 6, health: 10 } }],
          },
        ],
      },
      {
        ...
        outcomes: [
          {
            ...
            effects: [{ stats: { money: 20000, mindset: -8, health: -8 } }],
          },
        ],
      },
      {
      ...
      },
      {
        ...
        outcomes: [
          ...
          },
          {
            ...
            effects: [{ stats: { money: -32000, health: -14, mindset: -6 } }],
          },
        ],
      },
      {
        ...
        outcomes: [
          {
            ...
            effects: [{ stats: { health: -10, mindset: -5 } }],
          },
        ],
      },
    ],
        ...
        outcomes: [
          {
            ...
            effects: [{ stats: { money: -15000, mindset: -8, network: 2 } }],
          },
          {
            weight: 1,
            text: '房东态度坚决:"我只认钱,不认你们的合同。"谈崩了。你连夜找了新房子,搬家、押金、中介费又是一笔。那半年你的账单像被抢劫过,唯一的收获是:再签租房合同,你逐字逐句看了三遍。',
            effects: [{ stats: { money: -24000, mindset: -6, health: -3 } }],
          },
        ],
      },
      {
        ...
        outcomes: [
          {
            ...
            effects: [{ stats: { money: -30000, mindset: -9, health: -4 } }],
          },
        ],
      },
      {
        ...
        outcomes: [
          ...
          },
          {
            ...
            effects: [{ stats: { money: -22000, mindset: -9, network: 4 } }],
          },
        ],
      },
    ],
        ...
        outcomes: [
          {
            ...
            outcomeTag: 'failure',
            effects: [{ stats: { money: -70000, mindset: -9, health: -8 } }],
          },
          {
            weight: 1,
        ...
        outcomes: [
          {
            ...
            effects: [{ stats: { money: 50000, mindset: -8, network: -5 } }],
          },
        ],
      },
    ],
        ...
        outcomes: [
          {
            ...
            effects: [{ stats: { mindset: -6, health: -8 } }],
          },
        ],
      },
      {
        ...
        outcomes: [
          {
            ...
            effects: [{ stats: { money: 6000, network: -10, mindset: -8 } }],
          },
          {
            weight: 1,
        ...
        outcomes: [
          {
            ...
            effects: [{ stats: { money: -25000, mindset: -8, network: -4 } }],
          },
        ],
      },
      {
        ...
        outcomes: [
          ...
          },
          {
            ...
            effects: [{ stats: { money: -19800, mindset: -6 } }],
          },
        ],
      },
      {
