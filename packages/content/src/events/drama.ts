...
export const dramaEvents: GameEvent[] = [
  ...
  },
  {
    ...
    choices: [
      ...
      {
        id: 'd',
        text: '你听出他真正想说的不是钱——先问问店的事',
        visibleIf: { flag: 'trait_sensitive' },
        outcomes: [
          {
            weight: 2,
            text: '你没接“利息”那个话茬,只是问:“铺面签了吗?装修报价拿了几家?”电话那头沉默了几秒,然后他讲了四十分钟——讲到一半你就听明白了,他要的不是钱,是有人告诉他这事能不能干。你陪他把账算了三遍,算到凌晨,他说:“我再缓半年。”半年后他挑了个更好的铺面,启动资金自己攒够了。开业那天他敬你的酒里说:“当年那通电话,你是唯一没把我当借钱的。”',
            effects: [{ stats: { network: 7, mindset: 5, knowledge: 2 } }],
          },
          {
            weight: 1,
            text: '你听得很仔细,也问得很仔细——太仔细了。问到第三个成本问题时,他的声音冷了下来:“你直说借不借就行,查户口呢?”电话不欢而散。你复盘了很久:你确实听出了他的不安,但深夜打电话借钱的人,有时候只想要一个痛快的答案,不想要一面镜子。',
            effects: [{ stats: { network: -3, mindset: -4, knowledge: 2 } }],
          },
        ],
      },
    ],
  },
  {
    ...
    choices: [
      ...
      {
        id: 'd',
        text: '不裸辞也不硬撑:骑驴找马,慢慢挑',
        visibleIf: { flag: 'trait_chill' },
        outcomes: [
          {
            weight: 2,
            text: '你把辞职信从草稿箱移进了收藏夹,然后用三个月不紧不慢地面了七家公司——反正有工资垫底,你挑得起。第八家给了你一个环境和薪资都好一截的 offer,交接那天领导才知道你早就在看机会。愤怒的人裸辞,焦虑的人硬撑,松弛的人骑驴找马——你从来不觉得这算什么智慧,就是不爱让情绪替自己做决定。',
            effects: [{ stats: { money: 15000, mindset: 6, network: 3 } }],
          },
          {
            weight: 1,
            text: '“慢慢挑”的风险是市场比你还能等。面了几家都不合适,一拖就是一年,原岗位的锅照背,新机会的门没开。你没有变得更惨,只是卡在了一种温吞的悬置里。年底你重新打开那封辞职信,发现自己已经不记得当初非走不可的理由了——这不知道算治愈,还是算麻木。',
            effects: [{ stats: { money: 8000, mindset: -5 } }],
          },
        ],
      },
      {
