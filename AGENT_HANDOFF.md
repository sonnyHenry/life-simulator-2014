...
注意:title 还保留 M3 字样,但功能进度已经推进到 M5 第三轮。后续可以改成更中性的 `2014:我的十二年`。
...
```text
事件覆盖: 67/67
结局 12 个全部到达,无结局 >30%(平凡之路 28.7%,AI 幸存者 14.4%)
金钱分位: p10=¥7200 p50=¥70700 p90=¥224700
提前结局占比: 0.8%
```
